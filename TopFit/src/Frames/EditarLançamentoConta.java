...
public class EditarLançamentoConta extends javax.swing.JFrame implements Runnable{
    ...
    public void searchAluno(String id) {
        ...
        jTextFieldRecibo.setText(String.valueOf( Recibo));
    }
    ...
    private void initComponents() {
        ...
        ButtonRipleLancar.setText("Salvar");
        ...
        jTextFieldRecibo.setFont(new java.awt.Font("Georgia", 3, 14)); // NOI18N
        jTextFieldRecibo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldRecibo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(0, 0, 0)));
        jTextFieldRecibo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        jTextFieldRecibo.setOpaque(false);
        jTextFieldRecibo.setSelectionColor(new java.awt.Color(0, 0, 0));
        ...
        rSPanelGradiente1Layout.setHorizontalGroup(
            ...
            .addGroup(rSPanelGradiente1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jTextFieldRecibo, javax.swing.GroupLayout.PREFERRED_SIZE, 57, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(14, 14, 14)
            ...
            .addGroup(rSPanelGradiente1Layout.createSequentialGroup()
                ...
                .addGroup(rSPanelGradiente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(rSPanelGradiente1Layout.createSequentialGroup()
                        ...
                        .addComponent(jTextFieldRecibo, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
    ...
    private void ButtonRipleLancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonRipleLancarActionPerformed
        ...
        if (Data_matricula_recebe.getDate() == null) {
            ...
            try {
                ...
                PreparedStatement ps = con.prepareStatement("UPDATE pagamentos SET id_aluno = ?,descricao = ?,valor = ?,data = ?,hora = ?,data_vencimento = ? WHERE recibo = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarLançamentoConta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarLançamentoConta().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTextField jTextFieldRecibo;
