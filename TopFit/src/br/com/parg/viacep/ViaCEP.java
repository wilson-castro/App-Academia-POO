...
public class ViaCEP extends ViaCEPBase {
    ...
    public final void buscar(String cep) throws ViaCEPException {
        ...
        if (!obj.has("erro")) {
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível encontrar o Endereço!!");
            //throw new ViaCEPException("Não foi possível encontrar o Endereço", cep, ViaCEPException.class.getName());
        }
    }
        ...
        if (ceps.length() > 0) {
            for (int i = 0; i < ceps.length(); i++) {
                ...
                if (!obj.has("erro")) {
                   ...
                   // JOptionPane.showMessageDialog(null, "Não foi possível validar o C.E.P.");
                    //throw new ViaCEPException("Não foi possível validar o CEP", currentCEP, ViaCEPException.class.getName());
                }
            }
        } else {
            JOptionPane.showMessageDialog(null, "Nenhum C.E.P encontrado!!");
